...
<template>
  <form @submit.prevent="authStore.handleResetPassword(form)"
    ...
    <div class="mb-6">
      <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-dark-500">Email</label>
      <input type="email" v-model="form.email" id="email" class="
          shadow-sm
          bg-gray-50
